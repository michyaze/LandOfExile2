...
public class EventChoiceDwarvenGhostWeapon : EventChoice
{
    ...
    public override void PerformChoice()
    {
        ...
        MenuControl.Instance.heroMenu.RemoveCardFromDeck(MenuControl.Instance.heroMenu.hero.weapon);
        MenuControl.Instance.heroMenu.AddCardToDeck(NewWeapon);
        MenuControl.Instance.heroMenu.hero.weapon = NewWeapon;
