...
public class EventChoiceWitchCurseFoesTrade : EventChoice
{
    ...
    public override void PerformChoice()
    {
        ...
        if (cardsToShow.Count > 0)
        {
            ...
            actions.Add(() =>
            {
                ...
                int index = MenuControl.Instance.heroMenu.hero.startingEffects.IndexOf(effectTemplate);
                if (index > -1) MenuControl.Instance.heroMenu.hero.startingEffectCharges[index] += charges;
                else
                {
