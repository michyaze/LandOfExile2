...
public class EventChoiceWarriorTraining : EventChoice
{
    ...
    public override void PerformChoice()
    {
        ...
        while (cardsToShow.Count < 3)
        {
            ...
            foreach (var card in warriorClass.classCards)
            {
            ...
            Card randomCard = unlockedCards[Random.Range(0, unlockedCards.Count)];
