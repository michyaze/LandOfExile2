...
public class CutsceneMenu : BasicMenu
{
    public List<Cutscene> introCutscenes = new List<Cutscene>();
    public UIView view;
    ...
    public void ShowIntroCutscenes()
    {

        foreach (Cutscene cutscene in introCutscenes)
        {
            ShowCutscene(cutscene);
        }
        
        MenuControl.Instance. cutSceneFinished = true;
    }
