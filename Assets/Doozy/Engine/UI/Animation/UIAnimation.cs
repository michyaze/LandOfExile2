...
namespace Doozy.Engine.UI.Animation
{
    ...
    public class UIAnimation
    {
        ...
        public float StartDelay
        {
            ...
            set
            {
                if (Move.Enabled) Move.StartDelay = value;
                if (Rotate.Enabled) Rotate.StartDelay = value;
                if (Scale.Enabled) Scale.StartDelay = value;
                if (Fade.Enabled) Fade.StartDelay = value;
            }
        }
